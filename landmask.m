...
% Futher adapted by Alexander Fogal on 2022-04-08
%------------- BEGIN CODE --------------
function [isOcean] = landmask(lat,lon,coastal_res,make_plot)
% tic
switch nargin
    case 2
        coastal_res = 1;
...
[latlat,lonlon] = meshgrid(lat,lon);
val = geointerp(Z, R, latlat, lonlon);
isOcean = val == 2;
%isLand = ~isOcean;
